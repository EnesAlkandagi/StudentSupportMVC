    ...
    public class AuthManager : IAuthService
    {
        ...
        public IDataResult<User> Register(UserRegisterDto registerDto)
        {
            ...
            var user = new User
            {
                ...
                Type = registerDto.isOgrenci ? EnmUserType.Ogrenci : registerDto.isHayirSever ? EnmUserType.Yardimsever : EnmUserType.Ogrenci
        ...
        [SecuredOperation(Priority = 1, role = "Admin")]
