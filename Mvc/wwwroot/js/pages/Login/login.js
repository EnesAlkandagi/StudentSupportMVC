...
var KTLogin = function () {
    ...
    var _handleSignUpForm = function (e) {
        ...
        $('#kt_login_signup_submit').on('click', function (e) {
            ...
            var _iban = $("input[name=Iban]").val();
            var _pass = $("input[name=RPassword]").val();
            var _cPass = $("input[name=ConfirmPassword]").val();
            var _isOgrenci = $("input[name=isOgrenci]:checked").val();
            var _isHayirsever = $("input[name=isHayirsever]:checked").val();
            ...
            var _loginViewModel = {
                registerDto: {
                    ...
                    isOgrenci: _isOgrenci,
                    isHayirsever: _isHayirsever
                }
            }
                        ...
                        success: function (response) {
                            if (response.success) {
                                swal.fire({
                                    ...
                                    $("input[name=isOgrenci]").val(false);
                                    $("input[name=isHayirsever]").val(false);
                                    _showForm('signin');
                                });
                            } else {
                                swal.fire({
